...
Route::get('student/tardies', 'Api\StudentController@getTardies');
Route::get('student/class-tardies', 'Api\StudentController@getClassTardies');
Route::get('student/early-dismissals', 'Api\StudentController@getEDs');
