...
export default class EarlyDismissals extends Component {
    constructor() {
        super();
        this.state = {
            students: []
    ...
    componentWillMount() {
        axios.get('/api/student/early-dismissals').then((response) => {
            this.setState({
    ...
    render() {
        const fields = [
            ...
            { name: 'count', displayName: "Early Dismissals", inputFilterable: true, exactFilterable: false, sortable: true, render: this.getCount },
